...
The MPU9250 supports communication via I<sup>2</sup>C bus or the SPI bus.  With I<sup>2</sup>C you can run the
MPU9250 in &ldquo;master mode&rdquo;, meaning that you access all three sensors
(MPU6500 accelerometer/gyrometer, AK8963 magnetometer) at once, or &ldquo;pass-through
mode&rdquo; allowing you to communicate directly with the magnetometer, supporting more efficient data acquisition.  
...
development board, I<sup>2</sup>, master mode and pass-through mode

* Raspberry Pi 3, I<sup>2</sup>, master mode and pass-through mode
