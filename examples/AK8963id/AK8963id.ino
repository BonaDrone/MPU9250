...
static void writeAK8963Register(uint8_t subAddress, uint8_t data)
{
    ...
    bt.writeRegister(MPU9250_ADDRESS, I2C_SLV0_ADDR,AK8963_I2C_ADDR);

    // set the register to the desired AK8963 sub address 
    bt.writeRegister(MPU9250_ADDRESS, I2C_SLV0_REG,subAddress);

    // store the data for write
    bt.writeRegister(MPU9250_ADDRESS, I2C_SLV0_DO,data);

    // enable I2C and send 1 byte
    bt.writeRegister(MPU9250_ADDRESS, I2C_SLV0_CTRL,I2C_SLV0_EN | (uint8_t)1);
...
void setup(void)
{
    ...
    bt.writeRegister(MPU9250_ADDRESS, PWR_MGMNT_1,CLOCK_SEL_PLL);

    // enable I2C master mode
    bt.writeRegister(MPU9250_ADDRESS, USER_CTRL,I2C_MST_EN);

    // set the I2C bus speed to 400 kHz
    bt.writeRegister(MPU9250_ADDRESS, I2C_MST_CTRL,I2C_MST_CLK);

    // set AK8963 to Power Down
    writeAK8963Register(AK8963_CNTL1,AK8963_PWR_DOWN);

    // reset the MPU9250
    bt.writeRegister(MPU9250_ADDRESS, PWR_MGMNT_1,PWR_RESET);
