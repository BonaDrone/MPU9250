...
{  
    ...
    _bt->writeRegister(MPU9250_ADDRESS, CONFIG, 0x03);  
    ...
    if (_passthru) {
        ...
        // clear on read of INT_STATUS, and enable I2C_BYPASS_EN so additional chips 
        // can join the I2C bus and all can be controlled by the Arduino as master
        // See: https://github.com/kriswiner/MPU9250/issues/62

        //_bt->writeRegister(MPU9250_ADDRESS, INT_PIN_CFG, 0x22);// Continuous interrupt
        _bt->writeRegister(MPU9250_ADDRESS, INT_PIN_CFG, 0x12);  // INT is 50 microsecond pulse and any read to clear  
    }
    else {
